            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2>M-Funeral Dashboard </h2>
                    </div>
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb justify-content-end">
                            <li class="breadcrumb-item"><a href="{{route('get_dashboard')}}"><i class="icon-home"></i></a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x  fa-arrows-alt text-col-blue"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>FAMILIES</h6>
                                            <span class="font700">{{$family_count}}</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-minus-square text-col-green"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>DEATHS</h6>
                                            <span class="font700">{{$death_count}}</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="body">
                                    <div class="clearfix">
                                        ...
                                        <div class="number float-right text-right">
                                            <h6>FUNERALS</h6>
                                            <span class="font700">{{$funeral_count}}</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-shopping-cart text-col-yellow"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>DONATION</h6>
                                            <span class="font700">{{number_format($donation_sum,2)}}</span>
                                        </div>
                                    </div>
...
<div class="card">
<div class="header">
<h2><strong>Funerals</strong> Coming Up</h2>
